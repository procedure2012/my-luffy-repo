...
- [ ] `src/utils.py:9` - Implement password hashing logic
- [ ] `src/utils.py:14` - Add logging to all functions
- [ ] `src/utils.py:19` - Remove dead code (unused_func)
- [ ] `tests/test_utils.py:22` - Write tests for hash_password
- [ ] `tests/test_utils.py:26` - Add integration tests
